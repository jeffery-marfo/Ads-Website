...
const SingleAd = () => {
  ...
  return (
    <div className="flex flex-1/2 mt-10 justify-center m-20 pt-24">
      <section className="relative ml-10 p-10">
        <div>
          {ad.pictures?.length && (
            <img
              className="w-200 h-full ml-4 pb-2"
              src={`https://res.cloudinary.com/dnkydt52r/image/upload/${ad.pictures[0]}`}
              alt="black handbag"
            />
          )}
        </div>
        ...
        <div className="flex gap-2 ">
          <button
            className="p-2 border-2 border-gray-500 shadow-gray-500 transition duration-150 ease-in-out hover:bg-blue-950 cursor-pointer rounded-md bg-black text-white w-30"
            type="submit"
          >
            Start Order
          </button>
          ...
          <br /> <br />
          <button
            className="p-2 border-2 border-green-600  shadow-green-600 transition duration-150 ease-in-out hover:bg-green-950 cursor-pointer rounded-md bg-green-900 text-white w-30"
            type="submit"
          >
            Chart Now
          </button>
        ...
        <div>
          <br />
          <h2 className="font-bold text-lg">Available Payment Options</h2>
          <br />
