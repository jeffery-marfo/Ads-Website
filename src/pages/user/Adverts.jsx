  ...
  const filteredAds = ads.filter(
    (ad) =>
      (searchTerm === "" ||
        ad.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ad.description.toLowerCase().includes(searchTerm.toLowerCase())) &&
      ad.price >= priceRange.min &&
      ad.price <= priceRange.max
  );
          ...
          {filteredAds.map((ad) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-gray-700 mb-3">{ad.description}</p>
                <Link
                  to={`/adverts/${ad.id}`}
                  className="mt-4 px-6 bg-green-400 text-white py-2 rounded hover:bg-green-600 transition"
                >
                  View Details
                </Link>
              </div>
