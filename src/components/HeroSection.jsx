    ...
    <div className="relative w-full h-screen min-h-[500px]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <form
          ...
          className="w-full max-w-4xl bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-6"
        >
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <input
            ...
            <div className="flex-1">
              <div className="relative">
                <select
                  ...
                  className="appearance-none w-full bg-white px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500"
                >
                  <option>All Categories</option>
                  <option>Electronics</option>
                  <option>Vehicles</option>
            ...
            <div>
              <button
                type="submit"
                className="w-full md:w-auto px-6 py-3 bg-teal-500 text-white font-medium rounded-md hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition-colors"
              >
                Search
              </button>
            </div>
